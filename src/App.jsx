...
function App() {
  ...
  const { sellerLanding } = translations[lang];
    ...
    <div>
      <BrowserRouter>
        ...
        <Routes>
          ...
          />
          <Route path="/pricing" element={<Pricing pricing={pricing} setAddSeller={setAddSeller} />} />
          <Route
            path="/login"
            element={
              <Login
          ...
          <Route
            path="/become_a_seller"
            element={
              <BecomeSeller
                sellerLanding={sellerLanding}
                isLogin={isLogin}
